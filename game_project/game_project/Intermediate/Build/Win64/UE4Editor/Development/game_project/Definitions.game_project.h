...
#define UE_PROJECT_NAME game_project
#define UE_TARGET_NAME game_projectEditor
#define UE_MODULE_NAME "game_project"
...
#define GAME_PROJECT_API DLLEXPORT
